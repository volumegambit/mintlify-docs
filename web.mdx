...
Keep typing while your agent responds. **Send** opens a choice between **Steer**, which guides the
response in progress, and **Follow Up**, which queues another request. Closing the choice keeps your
draft and images. Edit or remove queued items before they start.
