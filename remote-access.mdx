...
Dash for Android connects to your HQ over your local Wi-Fi by default, and can also pair
...
<CardGroup cols={2}>
  <Card title="Use the relay" icon="globe">
    ...
    your phone and the HQ are on different networks. Dash for iOS always uses this path.
  </Card>
...
<Steps>
  ...
  <Step title="Connect your phone or tablet">
    ...
    **iOS:** open Dash on your iPhone or iPad and tap **Sign In**. Sign in with the same
    Dash account, then tap your HQ in the list — see [Dash for iPhone and
    iPad](/ios#sign-in) for the full flow. There's no QR code to scan.
  </Step>
</Steps>

Dash for iOS and Desktop share the HQ-authoritative conversation history, including
