...
DashSquad for iOS always connects through the hosted relay: sign in with your Dash account and pick
...
route HTTP and WebSocket traffic. Your Dash sign-in identifies you, each HQ gets
...
<Steps>
  ...
  <Step title="Connect your phone or tablet">
    ...
    **iOS:** open DashSquad on your iPhone or iPad and tap **Sign In**. Sign in with the same
    Dash account, then tap your HQ in the list — see [DashSquad for iPhone and
...
Signing out of Dash on this machine stops new HQs and pairings from being
