...
<Tabs>
  ...
  <Tab title="browser">
    Browse and interact with websites in a real browser — a headless Chrome or Edge on the HQ's machine. One toggle gives the agent eight `browser_*` tools: open, navigate, read the page, click and type, screenshot, tabs, profiles, and close.
