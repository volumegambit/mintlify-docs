...
remote access you sign in to Dash and act on behalf of an organization; the HQs and
...
Desktop and the Dash phone app see the same active turn when they use the same capable
