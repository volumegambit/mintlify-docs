...
DashSquad for iOS and capability-aware Desktop share one view. They render the same
HQ-authoritative conversation history. Android remains a legacy, non-resumable client in
