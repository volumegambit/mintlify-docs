...
description: "Manage your AI squad from the Mission Control desktop app."
---

Mission Control is your command center for Dash. Deploy new squad members, monitor running ones, chat with them directly, and connect them to messaging platforms — all from one place.
