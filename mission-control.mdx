...
While your agent works, press **Send** and DashSquad routes your message as a Steer or a Follow Up,
labeled **Auto-steered** or **Auto-queued**. When it is not sure, or when you press **Cmd+Return**,
choose **Steer** or **Follow Up** yourself. Both the main chat and a project conversation panel
...
Under **Settings → Chat → While a response is running**, choose how DashSquad delivers a message
sent while your agent is active:

- **Route automatically** — the default whenever the HQ has an OpenRouter key. DashSquad decides
  Steer or Follow Up itself and asks only when it is not confident.
- **Always ask** — every message opens the Steer/Follow Up choice, as before.

Without an OpenRouter key, the setting shows why automatic routing is unavailable and every message
asks, regardless of which option is selected.
