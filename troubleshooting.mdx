...
<AccordionGroup>
  <Accordion title="A connector shows Needs authorization">
    **Fix:** Tap **Authorize** on Desktop or your phone and finish signing in.
  </Accordion>

  <Accordion title='"This sign-in expired. Try again."'>
    **Fix:** Sign-in pages are valid for five minutes, once. Tap **Authorize** again.
  </Accordion>

  <Accordion title="Desktop doesn't come back after signing in">
    **Fix:** Desktop must be installed, not run from source, to catch the `dash://` link. Reinstall it, then tap **Authorize** again.
  </Accordion>
  ...
  <Accordion title="An agent lost a connector's tools after an update">
    **Fix:** Agents now use only the connectors their **Connectors** screen selects. Turn on **All connectors**, or pick the ones it needs.
  </Accordion>
</AccordionGroup>
