...
<AccordionGroup>
  ...
  <Accordion title="The delivery chooser is missing">
    On a current HQ, plain **Send** routes automatically on purpose — that's the point of automatic
    routing, not a missing control. Press **Cmd+Return** (**Ctrl+Enter** on Windows and in the web
    client) instead of **Send**, or touch and hold **Send** on iPhone, iPad, or Android, to open the
    chooser. If you never want automatic routing, choose **Always ask** under **Settings → Chat →
    While a response is running** in Desktop.
  ...
  <Accordion title="A message was auto-steered but I meant a Follow Up">
    A Steer can't be undone once it's delivered to the agent. Next time, press **Cmd+Return**
    (**Ctrl+Enter** on Windows and in the web client), or touch and hold **Send** on iPhone, iPad, or
    Android, to choose Follow Up yourself before sending. If you'd rather never have this happen,
    choose **Always ask** under **Settings → Chat → While a response is running**.
  </Accordion>
