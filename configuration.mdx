...
| `BROWSER_EXECUTABLE_PATH` | Full path to the browser the [browser tool](/browser) should use. It's the first place the HQ looks; if nothing exists at that path, the HQ falls back to finding Chrome or Edge as usual. |
