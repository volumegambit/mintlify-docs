...
DashSquad decides how to deliver it:
...
To choose yourself, press **Cmd+Return** (Ctrl+Enter on Windows and in the web client) instead of
**Send**. On iPhone, iPad, and Android, touch and hold **Send** to choose Steer or Follow Up
yourself. The choice offers:
