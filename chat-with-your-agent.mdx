...
**Send**. DashSquad decides how to deliver it:
...
**Send**. On iPhone, iPad and Android, touch and hold **Send** to choose yourself. The choice offers:
...
Automatic routing needs an OpenRouter key on your HQ. Without one, or with **Settings → Chat →
While a response is running → Always ask** in Desktop, every message asks.
