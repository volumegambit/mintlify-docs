...
description: "Step-by-step guide to deploying an AI squad member through Mission Control."
---

Ready to put your first AI squad member to work? This guide walks you through deploying a squad member using Mission Control — from opening the wizard to chatting with your new teammate.
...
<Steps>
  <Step title="Open the Deploy wizard">
    In Mission Control, click **Squad** in the sidebar, then **Deploy**. This opens the deployment wizard where you'll configure your new squad member.
  </Step>
