...
Squad members need an AI model to think — you bring your own API key. DashSquad supports Anthropic (Claude), OpenAI (GPT), and Google (Gemini). Each squad member can use a different provider, and you can set fallback models in case one is unavailable.
...
<CardGroup cols={3}>
  <Card title="Get started" icon="rocket" href="/getting-started">
    Install DashSquad and launch your first agent.
  </Card>
