...
| `PATCH` | `/conversations/:id` | Bearer + `If-Match` | Update the title |
...
| `GET` | `/providers` | Bearer | List AI providers and their keys (name, kind, when added, signed-in account) |
...
Updates the title. Requires `If-Match`.
