...
Keys you add there go into the same encrypted store on your HQ, so they show up in Desktop too, and the other way round. Once saved, a key is never shown again anywhere: the apps list each key's name and when it was added.
