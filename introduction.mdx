...
Whether you're a solo operator or running a team, DashSquad puts a crew of AI agents to work for you. Define what they do, set them loose, and check back on results.
...
Keep typing while your squad member works. Choose **Steer** to guide the response in progress, or
**Follow Up** to save the next request. Your queue follows the conversation across Desktop, web,
iPhone, iPad, and Android when connected to a current HQ. If a response fails, choose
**Resume Follow Ups** when you are ready to continue.

See [chat controls](/chat-with-your-agent#guide-a-response-or-queue-a-follow-up) for the details.
